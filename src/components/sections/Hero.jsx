                    ...
                    <div className="hero-copy">
                        <Reveal>
                            <span className="hero-badge">
                                <span className="dot" />
                                AI-ACCELERATED · ENTERPRISE-SECURED
                            </span>
                        </Reveal>
                        <Reveal as="h1" delay="1">
                            <span className="line">Build Enterprise</span>
                            <span className="line">
                                Software in <span className="grad-text">Weeks,</span>
                            </span>
                            <span className="line">
                        ...
                        <Reveal delay="3" className="hero-cta">
                            <Button href="#contact" variant="primary" arrow magnetic>
                                Start Your Project
                            </Button>
                            <Button href="https://calendly.com/d/d3f4-5n8-bnd" variant="ghost" icon="cal">
